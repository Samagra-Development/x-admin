    ...
    return (
      <Show {...props} title='Candiate details'>
        <TabbedShowLayout>
          ...
          <TextField label='Max Qualification' source='highest_level_qualification.highest_level_qualification_name'/>
          <TextField label='Qualification' source='qualification_detail.qualification_name'/>
          <TextField label='Marks' source='final_score_highest_qualification' />
          </Tab>
          <Tab label='Employment History'>
          <TextField label='Are you currently employed?' source='current_employment.current_employment_status' />
          <TextField label='Have you ever been employed?' source='ever_employment.employment_status' />            
            <FunctionField
          ...
          <TextField label='Driving License' source='driver_license.driver_license_choice' />
          <TextField label='Travel willingness' source='district_travel.district_travel_choice' />
          <TextField label='PAN CARD' source='pan_card.pan_card_choice' />
          <TextField label='English Speaking Competency' source='english_knowledge_choice.english_choice' />
          <TextField label='Computer Skills' source='computer_operator.computer_operator_choice' />
            ...
            />
            <TextField label='Expected Salary' source='expected_salary.salary_range' />
